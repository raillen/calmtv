# How-to — Use Commercial Streaming Services

Commercial service tiles launch a restricted Firefox ESR session only when selected.

1. Open a configured service tile.
2. Sign in through the service website.
